...
export function Hero() {
  ...
  return (
    <section id="inicio" className="hero">
      <img className="hero-image" src="/images/tattoo-hero.jpg" alt="Artista de TATTOO PERÚ tatuando un diseño de cóndor" fetchPriority="high" />
      <div className="hero-shade" />
      <div className="hero-content">
        <motion.p className="eyebrow" {...enter(0.1)}>Estudio de tatuajes en Lima</motion.p>
        <motion.h1 {...enter(0.18)}>TATTOO<br /><span>PERÚ</span></motion.h1>
